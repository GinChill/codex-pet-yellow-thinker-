Create a single horizontal sprite strip for the Codex app digital pet `yellow-thinker` in the state `review`.
...
Animation action: thinking loop with clear contemplative pose.


State-specific requirements:
- Show thinking through a stable contemplative gesture (for example paw-to-chin), subtle blink, and head tilt.
- Keep the mood thoughtful and calm, not active reviewing-workflow energy.
- Maintain this clear "thinking" read across all frames.
